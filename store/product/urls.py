...
from .cart import add_cart,veiw_add,delete_cart,update_cart,checkout
from .cart import payment_failled, payment_sucessfuly
...
urlpatterns = [
    ...
    path('payment-success/<int:pk>',payment_sucessfuly,name="payment-success"),
    path('payment-failled',payment_failled,name="payment-failled"),
